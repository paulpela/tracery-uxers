...
var input = {
    ...
    "body": [ "<p><strong>#heroName# #heroSurname#</strong> is a #skillLevel# #heroProfession# living in #place#. #pronounHe.capitalize#'s #age# years old.</p>#storyPatternNumber#<p><strong>Personality:</strong> #pronounHe.capitalize# is #positiveTrait#, #positiveTrait# and #positiveTrait#. #pronounHe.capitalize#'s often #negativeTrait#.</p>" ],
    ...
    "usernameWord": [ "theGreat", "UX", "designer", "usability", "design" ],
    "usernamePrefix": [ "", "", "", "", "", "galaxy", "laser", "space", "rogue" ],
    ...
    "timeInPast": [ "two years ago", "three years ago", "four years ago", "five years ago" ],
    ...
    "objectQuality": [ "great-looking", "very usable", "well designed" ]
};
